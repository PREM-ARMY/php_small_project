...
$int_sql = "INSERT INTO personal_details (first_name, last_name, date_of_birth, gender, email, phone,address,grade,randam_id) 
  ...
  $result = mysqli_query($conn, $int_sql);
  if ($result ==1) {
    echo "<script>
...
{
    $username    = isset($_POST['usernameOrEmail']) ? $_POST['usernameOrEmail'] : '';
    $password    = isset($_POST['password']) ? $_POST['password'] : '';
    $qrySel = "select * from personal_details where email='$username' and phone ='$password'";
